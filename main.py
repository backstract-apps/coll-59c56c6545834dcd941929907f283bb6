...
app = FastAPI(title='Backstract Generated APIs - coll-59c56c6545834dcd941929907f283bb6', debug=False,
              docs_url='/funny-lamarr-65d12a6c452811f0aa4e321ba161ea1a59/docs',
              openapi_url='/funny-lamarr-65d12a6c452811f0aa4e321ba161ea1a59/openapi.json')
...
app.include_router(
    router,
    prefix='/funny-lamarr-65d12a6c452811f0aa4e321ba161ea1a59/api',
    tags=['APIs v1']
)
...
async def prometheus_middleware(request: Request, call_next):
    ...
    try:
        ...
        if "/metric" not in request.url.path or "/loki" not in request.url.path:
